...
The parent may add a second specialist only for a specific unresolved need, an independent workstream, or materially useful independent verification. Team mode permits concurrent independent workstreams, but it does not justify a complexity swarm or a default chain of Fixer → Reviewer → Verifier.
